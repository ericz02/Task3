...
import ProductReduce from './components/ProductReduce';
import ProductSort from './components/ProductSort';
import ArrayMap from './components/ProductMap';
  ...
  return (
    <div className="App w-[50%] mx-auto py-5">
      ...
      <section className='py-5'>
        {componentToShow === 'filter' && <ProductFilter />}
        {componentToShow === 'reduce' && <ProductReduce />}
        {componentToShow === 'sort' && <ProductSort />}
        {componentToShow === 'map' && <ProductMap />}
      </section>
    </div>
  )
}
